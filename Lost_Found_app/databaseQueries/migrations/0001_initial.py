...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('register_date', models.DateTimeField(default=datetime.time(13, 36, 8, 336889))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('edited_time', models.DateTimeField()),
                ('content', models.TextField(max_length=1000)),
                ('announcement_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='databaseQueries.announcement')),
